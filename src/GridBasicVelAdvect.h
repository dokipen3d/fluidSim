#ifndef GRIDBASICVELADVECT_H
#define GRIDBASICVELADVECT_H
...
class GridBasicVelAdvect : public GridOperator {

public:
  GridBasicVelAdvect(GridObject *inGridObject) : GridOperator(inGridObject) {
    cout << "in GridEmitter Constructor" << endl;
    setupDefaults();
  };
  virtual ~GridBasicVelAdvect();
