...
void GLVertexArrayObject::setVertexAttributeDataPointer(GLVertexBufferObject &bufferToBind, GLuint shaderAttributePosition, GLint sizeOfData)
{

    bufferToBind.bind();
    glVertexAttribPointer (shaderAttributePosition, sizeOfData, GL_FLOAT, GL_FALSE, 0, NULL);//set vertex pointer offset info for CURRENTLY BOUND BUFFER
