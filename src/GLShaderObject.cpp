...
bool GLShaderObject::loadProgram(const char *vertex_path,
...
void GLShaderObject::freeProgram() { glDeleteProgram(mProgramID); }
...
GLuint GLShaderObject::getProgramID() { return mProgramID; }
