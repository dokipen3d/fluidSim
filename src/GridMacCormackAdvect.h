#ifndef GRIDMACCORMACKADVECT_H
#define GRIDMACCORMACKADVECT_H
...
class GridMacCormackAdvect : public GridOperator {

public:
  GridMacCormackAdvect(GridObject *inGridObject) : GridOperator(inGridObject) {
    cout << "in GridEmitter Constructor" << endl;
    setupDefaults();
  };
  virtual ~GridMacCormackAdvect();
